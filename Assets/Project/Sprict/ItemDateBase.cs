...
public class ItemDateBase : MonoBehaviour
{
    ...
    public void synthesis()
    {
        ...
        //洗剤と瓶で洗剤瓶の制作
        if (GetItemId(25).selectedItem == true && GetItemId(27).selectedItem == true)//塩素系のほう
        {
        ...
        else if (GetItemId(26).selectedItem == true && GetItemId(27).selectedItem == true)//酸性のほう
        {
            inventry.Add(GetItemId(28));
            inventry.Delete(GetItemId(27));
        ...
        //洗剤と洗剤瓶でガス入り瓶の制作
        if (GetItemId(25).selectedItem == true && GetItemId(28).selectedItem == true)//塩素系のほう
        {
        ...
        else if (GetItemId(26).selectedItem == true && GetItemId(28).selectedItem == true)//酸性のほう
        {
            inventry.Add(GetItemId(29));
            inventry.Delete(GetItemId(28));
            inventry.Delete(GetItemId(26));
