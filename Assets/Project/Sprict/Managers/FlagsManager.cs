        ...
        if (true) //日本語の時
        {
            switch (LocationName)
            {
                ...
                case "Minnka2-16":
                    ...
                    break;
                case "Minnka2-17":
                    locationText.text = "診察室";
                    break;
                case "Minnka2-18":
                    locationText.text = "2F廊下";
                    break;
                case "Minnka2-19":
                    locationText.text = "子供部屋";
                    break;
                case "Minnka2-20":
                    locationText.text = "2F廊下";
                    break;
                case "Minnka2-21":
                    locationText.text = "雑務室";
                    break;
                case "Minnka2-22":
                    locationText.text = "診察室";
                    break;
                case "Minnka2-23":
                    locationText.text = "簡易手術室";
                    break;
                case "Minnka2-24":
                    locationText.text = "診察室";
                    break;
                case "Minnka2-25":
                    locationText.text = "2Fトイレ";
                    break;
                case "Minnka2-26":
                    locationText.text = "2F廊下";
                    break;
