...
public class Cooktop : MonoBehaviour
{
    ...
    public void OnclickDish1IngredientsButton()
    {
        ...
        {
            MessageManager.message_instance.MessageWindowActive(dish1Messages,dish1Names,dish1Image);
            ingredients.gameObject.SetActive(false);
        ...
        {
            MessageManager.message_instance.MessageWindowActive(dishFailMessages, dishFailNames, dishFailImage);
            ingredients.gameObject.SetActive(false);
            inventry.Delete(itemDateBase.items[11]);
            itemDateBase.items[11].checkPossession = false;
            if(itemDateBase.items[15].checkPossession == true)
    ...
    public void OnclickDish2IngredientsButton()
    {
        ...
        {
            MessageManager.message_instance.MessageWindowActive(dish2Messages, dish2Names, dish2Image);
            ingredients.gameObject.SetActive(false);
    ...
    public void OnclickDish3IngredientsButton()
    {
        ...
        {
            MessageManager.message_instance.MessageWindowActive(dish3Messages, dish3Names, dish3Image);
            ingredients.gameObject.SetActive(false);
